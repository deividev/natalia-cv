...
CV Nata/
│
├── 📄 index.html              ← Página web (NO MODIFICAR)
├── 🎨 styles.css              ← Estilos (Solo modificar colores si quieres)
│
├── ⚙️ config.js               ← ⭐ ARCHIVO PRINCIPAL - EDITAR AQUÍ ⭐
│
├── 📖 README.md               ← Guía completa y detallada
├── 🚀 INICIO-RAPIDO.md        ← Guía rápida (5 minutos)
├── ✓ CHECKLIST.md             ← Lista de verificación
├── 💡 ejemplos-config.js      ← Ejemplos y plantillas
│
└── 📂 images/ (crear)         ← Carpeta para tus imágenes (opcional)
    ├── perfil.jpg
    └── hero.jpg
```
...
2. Abre config.js
          ↓
3. Cambia datos básicos (nombre, WhatsApp, redes)
          ↓
4. Personaliza textos principales
          ↓
5. Guarda y abre index.html en navegador
          ↓
6. ¿Se ve bien? → Continúa personalizando
          ↓
7. Consulta ejemplos-config.js para inspiración
          ↓
8. Usa CHECKLIST.md para verificar todo
          ↓
9. Lee README.md para publicar tu web
          ↓
10. ¡LISTO! 🎉
```
...
1. **Ahora:** Lee `INICIO-RAPIDO.md`
2. **Luego:** Edita `config.js`
3. **Después:** Usa `CHECKLIST.md`
4. **Finalmente:** Publica según `README.md`

---

**¿Listo para empezar? → Abre `INICIO-RAPIDO.md` 🎉**
