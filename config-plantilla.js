...
const CONFIG = {
  ...
  textos: {
    ...
    sobreMiParrafo1:
      "Soy [Nombre], asesora de seguros de salud con [X] años de experiencia. Mi pasión es ayudar a las personas a proteger lo más importante: su salud y la de sus seres queridos.",
    sobreMiParrafo2:
      "Me especializo en seguros Sanitas y he ayudado a más de [X] familias a encontrar la cobertura perfecta. Cuento con certificación profesional y actualización constante.",
    sobreMiParrafo3:
      "Mi filosofía de trabajo es simple: escuchar tus necesidades, explicar todas las opciones de forma clara y acompañarte en cada paso. Tu tranquilidad es mi prioridad.",
