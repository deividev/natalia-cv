...
const EJEMPLO_COMPLETO = {
    ...
    textos: {
        ...
        heroDescripcion: "Como asesora certificada de seguros de salud, mi misión es ayudarte a encontrar la mejor cobertura para ti y tu familia. Asesoramiento gratuito, personalizado y sin compromisos.",
        
        sobreMiParrafo1: "Soy María García, asesora de seguros de salud con más de 10 años de experiencia en el sector. Mi pasión es ayudar a las personas a proteger lo más importante: su salud y la de sus seres queridos.",
        sobreMiParrafo2: "Me especializo en seguros Sanitas y he ayudado a más de 500 familias a encontrar la cobertura perfecta. Cuento con certificación profesional y actualización constante en productos de salud.",
        sobreMiParrafo3: "Mi filosofía de trabajo es simple: escuchar tus necesidades, explicar todas las opciones de forma clara y acompañarte en cada paso del proceso. Tu tranquilidad es mi prioridad.",
...
const EJEMPLO_TESTIMONIOS = {
    testimonios: [
        {
            estrellas: 5,
            texto: "María me ayudó a encontrar un seguro perfecto para toda mi familia. Su atención es excepcional y siempre está disponible para resolver dudas. Muy recomendable.",
            autor: "Laura M."
        },
        {
            estrellas: 5,
            texto: "Profesional, cercana y con gran conocimiento del sector. Gracias a su asesoramiento tengo un seguro de calidad a buen precio.",
            autor: "Jorge P."
        },
        {
            estrellas: 5,
            texto: "Me explicó todas las opciones con mucha claridad. El seguimiento post-venta es excelente. Sin duda la mejor decisión.",
            autor: "Carmen R."
        },
        {
            estrellas: 5,
            texto: "Llevo 3 años trabajando con ella y no puedo estar más contento. Gestión rápida y eficiente de todo lo relacionado con mi póliza.",
            autor: "Roberto G."
        }
    ]
};
    ...
    preguntasFrecuentes: [
        {
            ...
            respuesta: "No, mi asesoramiento es 100% gratuito. Me paga la compañía aseguradora, no tú. El precio de tu seguro es el mismo contratar directamente o a través de mí, pero con mi asesoramiento tienes apoyo personalizado."
        },
        {
            pregunta: "¿Puedo cancelar mi seguro cuando quiera?",
            respuesta: "Sí, los seguros de salud se pueden cancelar cuando desees. Te ayudo con todos los trámites necesarios y te explico las condiciones de cancelación."
        },
        {
            pregunta: "¿Qué pasa si tengo una urgencia médica?",
            respuesta: "Sanitas ofrece atención de urgencias 24/7 los 365 días del año. Te explico cómo funciona el servicio y qué hacer en caso de emergencia."
        },
        {
            pregunta: "¿Puedo incluir a mi pareja e hijos?",
            respuesta: "Por supuesto. Los seguros familiares incluyen descuentos especiales. Estudio tu caso y te propongo la mejor opción para todos."
        },
        {
            pregunta: "¿Tendré un contacto directo contigo después de contratar?",
            respuesta: "Sí, siempre. Soy tu asesora permanente. Cualquier cambio, duda o incidencia, me contactas directamente y yo lo gestiono."
        }
    ]
};
